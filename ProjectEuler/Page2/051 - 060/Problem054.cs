...
namespace ProjectEuler.Page2._051___060
{
    ...
    public class Problem054
    {
        ...
        private enum Suit { Heart, Spade, Club, Diamond };

        private static Card[] hand1 = new Card[5];
        private static Card[] hand2 = new Card[5];
        private static string filename = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName + "/Assets/poker.txt";
        ...
        private static bool DidPlayer1Win(Card[] hand1, Card[] hand2)
        {
